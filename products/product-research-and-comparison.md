...
Product prices and availability change frequently across retailers.
...
Summary: Best lead as of 2026-08-05 15:59 - Sony WH-1000XM5 $328 (Best Buy) - verify price before buying.

Example of an incorrect Summary line:

Summary: Best headphones are the Sony WH-1000XM5 at $328.
...
Immediately before finalizing the result, re-check the top recommendation's source link one more time.

Confirm whether the price still matches what was found earlier in the run.

- If it matches, note "confirmed at [time]" next to the top result.
- If it has changed or the product is no longer available, note "changed since first seen - verify before acting" and update the figure if a new one is visible.
